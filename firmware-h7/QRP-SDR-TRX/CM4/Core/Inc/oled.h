...
/*
 * Minimal SSD1306 driver, 128x64 over I2C1 (PB6/PB7 on this board's .ioc,
 * address 0x3C). Uppercase-only 5x7 font covering space, 0-9, and the
 * letters this project's bring-up tests actually print (CDEHLNORTUW),
 * plus ':' and '-'. Characters outside that set are skipped rather than
 * guessed at.
 */
